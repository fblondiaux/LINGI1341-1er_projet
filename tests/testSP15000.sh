...
dd if=/dev/urandom of=input_file bs=1 count=15000 &> /dev/null

# On lance le simulateur de lien avec 10% de pertes et un délais de 50ms
./link_sim -p 1341 -P 2456 -l 00 -d 50 -R  &> link.log &
link_pid=$!
...
echo "Debut du test, sans pertes, 15000 octets, fichier contenant des valeurs random"
